  ...
  class TimelineEntryComponentPreview < ViewComponent::Preview
    ...
    def sample_entries
      ...
      [
        ...
        [ "email", "Email: Welcome to Acme", { "mailer" => "UserMailer" } ],
        ...
        [ "subscription", "Subscription trialing: Acme Pro", { "plan" => "price_pro", "trial_ends_at" => (now + 14.days).iso8601 } ],
        [ "subscription_ended", "Subscription ended: Acme Pro", {} ],
        [ "event", "Registered", {} ],
